...
import {
  ...
  sourceForPrompt,
  dataSourceConfig,
} from "./CustomerSupportAgentConfigs";
...
import useAiAgentNodeParameterState from "./useCustomerSupportNodeParameter";
import { aiAgentNodeDataEncoder } from "./customerSupportAgentNodeDataEncoder";

const CustomerSupportAgentNodeParameter: Component<{}> = (props) => {
...
export default CustomerSupportAgentNodeParameter;
